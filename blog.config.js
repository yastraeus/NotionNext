...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'YASTRAEUS', // 您的昵称 例如 tangly1024 
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8478694200', // 对应歌单的 id
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/=).png', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
